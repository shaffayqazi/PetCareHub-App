      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text("Pet Notes", style: primaryTextStyle()),
            SizedBox(
              height: 23,
              child: TextButton(
                ...
                //TODO String Translation
                child: Text("See Pet Profile", style: secondaryTextStyle(color: primaryColor)).paddingSymmetric(horizontal: 8, vertical: 2),
              ),
            ),
          ],
        ).paddingSymmetric(horizontal: 16),
  ...
  Widget employeeInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        //TODO String Translation
        Text("Employee Information", style: primaryTextStyle()).paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding: const EdgeInsets.only(left: 16, right: 16, top: 16),
          decoration: boxDecorationDefault(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // TODO String Translation
                  detailWidget(title: "Designation", value: getEmployeeRoleByServiceElement(appointment: bookingController.bookingDetail.value)),
  ...
  Widget petInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        //TODO String Translation
        Text("Pet Information", style: primaryTextStyle()).paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding: const EdgeInsets.only(left: 16, right: 16, top: 16),
          decoration: boxDecorationDefault(
